...
reviews.signUpWithEmailAddressAndPassword = (emailAddress, password) => {
    return new Promise((resolve, reject) => {
...
reviews.signIn = (emailAddress, password) => {
    return new Promise((resolve, reject) => {
        if (!emailAddress || !password) {
            reject(new Error("No e-mail address or password"));
...
reviews.sendSignInLinkToEmail = (emailAddress) => {
    return new Promise((resolve, reject) => {
        if (!emailAddress) {
...
reviews.signInWithEmailLink = (emailAddress, emailLink) => {
    return new Promise((resolve, reject) => {
...
reviews.signInWithAuthProvider = (provider) => {
    return new Promise((resolve, reject) => {
        if (!provider) {
...
reviews.linkAuthProvider = (provider) => {
    return new Promise((resolve, reject) => {
        if (!provider) {
            reject(new Error("No provider"));
...
reviews.unlinkAuthProvider = (providerId) => {
    return new Promise((resolve, reject) => {
        if (!providerId) {
...
reviews.authProviderData = (providerId) => {
    if (!providerId) {
        return;
    }
...
reviews.resetPassword = (emailAddress) => {
    return new Promise((resolve, reject) => {
        if (!emailAddress) {
            reject(new Error("No e-mail address"));
...
reviews.changeFirstName = (firstName) => {
    return new Promise((resolve, reject) => {
        if (!firstName) {
...
reviews.changeEducation = (education) => {
    return new Promise((resolve, reject) => {
        if (!education) {
...
reviews.changeLastName = (lastName) => {
    return new Promise((resolve, reject) => {
        if (!lastName) {
...
reviews.changeUsername = (username) => {
    return new Promise((resolve, reject) => {
        if (!username) {
...
reviews.changeEmailAddress = (emailAddress) => {
    return new Promise((resolve, reject) => {
        if (!emailAddress) {
            reject(new Error("No e-mail address"));
...
reviews.changePassword = (password) => {
    return new Promise((resolve, reject) => {
        if (!password) {
...
reviews.getNameInitials = (fields) => {
    if (!fields) {
        return null;
    }
...
reviews.getProfileCompletion = (fields) => {
    if (!fields) {
        return null;
    }
...
reviews.getSecurityRating = (user, userData) => {
